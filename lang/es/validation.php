...
return [
    ...
    | utilizados por la clase validador. Algunas de estas reglas tienen múltiples versiones
    | tales como las reglas de tamaño. Siéntase libre de modificar cada uno de estos mensajes aquí.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puede especificar mensajes de validación personalizados para atributos usando la
